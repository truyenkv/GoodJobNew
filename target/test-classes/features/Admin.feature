...
#
  ...
  Scenario: Create Company account
    ...
    And Input required field are Company Name: "Cdbently 031", Company Identifier: "11-1111111" and select required drop down box.
    ...
    And Add user with Fist Name is "user2 fName", Last Name is "user2 lName", and Email is "cd.0031@yopmail.com"
    And Click on Save button on Manage Company screen.
    Then System should navigate to Manage Companies screen and "Manage Companies" should shown.
    And "Cdbently 031" Shows correctly be shown on Manage Companies screen.
